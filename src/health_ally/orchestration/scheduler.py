...
from health_ally.persistence.models import ScheduledJob

if TYPE_CHECKING:
    from sqlalchemy.ext.asyncio import AsyncEngine, AsyncSession, async_sessionmaker

    from health_ally.domain.scheduling import CoachConfig
    from health_ally.orchestration.jobs import JobDispatcher
    ...
    async def run(self) -> None:
        ...
        while not self._shutdown_event.is_set():
            ...
            if self._coach_config and self._poll_count % _SWEEP_INTERVAL_POLLS == 0:
                try:
                    from health_ally.orchestration.reconciliation import sweep_missing_jobs
